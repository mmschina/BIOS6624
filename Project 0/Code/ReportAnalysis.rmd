...
# Question 1
Question: What is the agreement between the subject’s recordings of sampling times compared to the times recorded by an electronic monitoring cap?
...
ggplot(data_clean_one, aes(x = booklet_time_min, y = cap_time_min)) +
  ...
  labs(x = "Booklet Time (minutes)",
       y = "Cap Time (minutes)",
       title = "Analysis of Agreement of Time Measurements")
