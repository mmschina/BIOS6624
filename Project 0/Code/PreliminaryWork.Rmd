...
- In the nmol units: cortisol range: over 26 is unlikely (don't necessarily remove), over 80 is incorrect (lab error); DHEA range: 5.205 is upper limit of machine (maximum level of detection), that is also likely an error
